    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Cambiamento password completato.", If(message = "SetPwdSuccess", "Impostazione password completata.", If(message = "RemoveLoginSuccess", "L'account è stato rimosso.", [String].Empty)))
