    ...
    Protected Sub Page_Load() Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ElseIf User.Identity.IsAuthenticated Then
                Dim verifiedloginInfo = Nothing
                'Context.GetOwinContext().Authentication.GetExternalLoginInfo(IdentityHelper.XsrfKey, User.Identity.GetUserId())
